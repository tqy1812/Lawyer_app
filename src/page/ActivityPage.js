                    ...
                    <ScrollView>
                        ...
                        </View>
                        {
                           list && JSON.stringify(this.props.caseList)!='{}' &&  list.map((item, index)=>{
                                ...
                                let color = this.props.caseList[item.case.id+'']; //Common.color[index % 5];
                                // console.log(color)
                                return (
...
const styles = StyleSheet.create({
 ...
 backBtn: {height:25, left: 10, top: 10, position: 'absolute', zIndex: 999},
 content: {
    flex: 1,
    flexDirection: 'row'
 },
