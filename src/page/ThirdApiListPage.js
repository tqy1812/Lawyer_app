...
class ThirdApiListPage extends Component {
          ...
          <SafeAreaView style={styles.container}>  
            ...
            { this.state.loading && <View style={styles.mask}>
                    ...
                    <View style={styles.container}>                    
                    {
                        ...
                        ref={this.wv}
                        source={{ uri:  Common.webUrl + 'threePart/three.html' }}
...
export default connect(ThirdApiListPage.mapStateToProps)(ThirdApiListPage);
