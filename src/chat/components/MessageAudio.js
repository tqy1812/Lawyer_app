            ...
            <View style={[styles.container]}>
                {
                    msg.isOutgoing?(
                        <Fragment>
                            <Text style={[{color:'#fff',fontSize:12,lineHeight:35}, msg.isOutgoing ? {marginLeft:5} : { marginRight:5}]}> {Math.ceil((msg.duration)/1000)}'' </Text>
                        ...
                        <Fragment>
                            ...
                            <Text style={[{color:'#666666',fontSize:12,lineHeight:35}, msg.isOutgoing ? {marginLeft:5} : { marginRight:5}]}> {Math.ceil((msg.duration)/1000)}'' </Text>
                        </Fragment>
                    )
                }
