...
class TimePickerList extends Component {
    ...
    _renderItem = ({item, index}) => {
        const {keyType, hourSuffix, minuteSuffix} = this.props;
        const suffix = keyType === DATE_KEY_TYPE.START_HOUR || keyType === DATE_KEY_TYPE.END_HOUR ? hourSuffix : minuteSuffix;
        return (<View style={[styles.datePickerListItemView, {height: this.state.rowHeight}]}>
            <Text style={this._itemTextStyle(index)}>{item}{ item!=='' && item!=='~' && suffix}</Text>
        </View>);
    };
    ...
    render() {
        ...
        return (
            <View style={{height: heightOfContainer}}>
                <View pointerEvents={'box-none'} style={this._lineStyle(BORDER_LINE_POSITION.TOP)}></View>
                <View pointerEvents={'box-none'} style={this._lineStyle(BORDER_LINE_POSITION.MIDDLE)}></View>
                <View pointerEvents={'box-none'} style={this._lineStyle(BORDER_LINE_POSITION.BOTTOM)}></View>
                <FlatList
