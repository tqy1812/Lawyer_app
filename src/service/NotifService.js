...
export default class NotifService {
  ...
  //   this.defaultChannelid = 'activity'
  //   this.soundChannelId = 'sound'
  ...
  //     {
  //       channelId: this.defaultChannelid, // (required)
  //       channelName: `user activity`, // (required)
  //       channelDescription: "user activity", // (optional) default: undefined.
  ...
  //   // PushNotification.createChannel(
  //   //   {
  //   //     channelId: this.soundChannelId, // (required)
  ...
  //     channelId: soundName ? this.soundChannelId : this.defaultChannelid,
